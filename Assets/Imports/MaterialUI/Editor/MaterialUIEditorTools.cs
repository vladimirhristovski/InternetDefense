	...
	public static class MaterialUIEditorTools
	{
		...
		private static void SetupObject(string objectName)
		{
			...
			if (notCanvas)
			{
				...
				{
					GameObject.Instantiate(AssetDatabase.LoadAssetAtPath("Assets/Imports/MaterialUI/ComponentPrefabs/EventSystem.prefab",
				...
				{
					selectedObject =
						GameObject.Instantiate(AssetDatabase.LoadAssetAtPath("Assets/Imports/MaterialUI/ComponentPrefabs/Canvas.prefab",
		...
		{
			theThing =
				GameObject.Instantiate(AssetDatabase.LoadAssetAtPath("Assets/Imports/MaterialUI/ComponentPrefabs/Background.prefab",
					typeof (GameObject))) as GameObject;
		...
		{
			theThing =
				GameObject.Instantiate(AssetDatabase.LoadAssetAtPath("Assets/Imports/MaterialUI/ComponentPrefabs/Panel.prefab",
					typeof (GameObject))) as GameObject;
			SetupObject("Panel");
		}
		...
		{
			theThing =
				GameObject.Instantiate(AssetDatabase.LoadAssetAtPath("Assets/Imports/MaterialUI/ComponentPrefabs/Text.prefab",
				                                                     typeof (GameObject))) as GameObject;
			SetupObject("Text");
		}
		...
		{
			theThing =
				GameObject.Instantiate(AssetDatabase.LoadAssetAtPath("Assets/Imports/MaterialUI/ComponentPrefabs/Button - Flat.prefab",
					typeof (GameObject))) as GameObject;
		...
		{
			theThing =
				GameObject.Instantiate(AssetDatabase.LoadAssetAtPath("Assets/Imports/MaterialUI/ComponentPrefabs/Button - Raised.prefab",
					typeof (GameObject))) as GameObject;
		...
		private static void CreateRoundButtonFlat()
		{
			theThing =
				GameObject.Instantiate(AssetDatabase.LoadAssetAtPath(
					"Assets/Imports/MaterialUI/ComponentPrefabs/Round Button - Flat.prefab", typeof (GameObject))) as GameObject;
		...
		private static void CreateRoundButtonRaised()
		{
			theThing =
				GameObject.Instantiate(
					AssetDatabase.LoadAssetAtPath("Assets/Imports/MaterialUI/ComponentPrefabs/Round Button - Raised.prefab",
						typeof (GameObject))) as GameObject;
		...
		private static void CreateSmallRoundButtonFlat()
		{
			theThing =
				GameObject.Instantiate(
					AssetDatabase.LoadAssetAtPath("Assets/Imports/MaterialUI/ComponentPrefabs/Round Button - Small - Flat.prefab",
						typeof (GameObject))) as GameObject;
		...
		private static void CreateSmallRoundButtonRaised()
		{
			theThing =
				GameObject.Instantiate(
					AssetDatabase.LoadAssetAtPath("Assets/Imports/MaterialUI/ComponentPrefabs/Round Button - Small - Raised.prefab",
						typeof (GameObject))) as GameObject;
		...
		private static void CreateSpinnyArrowButton()
		{
			theThing =
				GameObject.Instantiate(AssetDatabase.LoadAssetAtPath(
					"Assets/Imports/MaterialUI/ComponentPrefabs/SpinnyArrow Button.prefab", typeof (GameObject))) as GameObject;
		...
		{
			theThing =
				GameObject.Instantiate(AssetDatabase.LoadAssetAtPath("Assets/Imports/MaterialUI/ComponentPrefabs/Checkbox.prefab",
					typeof (GameObject))) as GameObject;
		...
		{
			theThing =
				GameObject.Instantiate(AssetDatabase.LoadAssetAtPath("Assets/Imports/MaterialUI/ComponentPrefabs/RadioGroup.prefab",
					typeof (GameObject))) as GameObject;
		...
		{
			theThing =
				GameObject.Instantiate(AssetDatabase.LoadAssetAtPath("Assets/Imports/MaterialUI/ComponentPrefabs/Switch.prefab",
					typeof (GameObject))) as GameObject;
			SetupObject("Switch");
		}
		...
		{
			theThing =
				GameObject.Instantiate(AssetDatabase.LoadAssetAtPath("Assets/Imports/MaterialUI/ComponentPrefabs/TextInput.prefab",
					typeof (GameObject))) as GameObject;
		...
		{
			theThing =
				GameObject.Instantiate(AssetDatabase.LoadAssetAtPath("Assets/Imports/MaterialUI/ComponentPrefabs/Slider.prefab",
					typeof (GameObject))) as GameObject;
			SetupObject("Slider");
		}
		...
		{
			theThing =
				GameObject.Instantiate(AssetDatabase.LoadAssetAtPath("Assets/Imports/MaterialUI/ComponentPrefabs/SelectionBox.prefab",
					typeof (GameObject))) as GameObject;
		...
		private static void CreateSelectionBoxFlat()
		{
			theThing =
				GameObject.Instantiate(AssetDatabase.LoadAssetAtPath(
					"Assets/Imports/MaterialUI/ComponentPrefabs/SelectionBox - Flat.prefab", typeof (GameObject))) as GameObject;
		...
		private static void CreateDialogBoxNormal()
		{
			theThing =
				GameObject.Instantiate(AssetDatabase.LoadAssetAtPath(
					"Assets/Imports/MaterialUI/ComponentPrefabs/DialogBox - Normal.prefab", typeof (GameObject))) as GameObject;
		...
		private static void CreateDialogBoxScroll()
		{
			theThing =
				GameObject.Instantiate(AssetDatabase.LoadAssetAtPath(
					"Assets/Imports/MaterialUI/ComponentPrefabs/DialogBox - Scroll.prefab", typeof (GameObject))) as GameObject;
		...
		private static void CreateDialogBoxSimple()
		{
			theThing =
				GameObject.Instantiate(AssetDatabase.LoadAssetAtPath(
					"Assets/Imports/MaterialUI/ComponentPrefabs/DialogBox - Simple.prefab", typeof (GameObject))) as GameObject;
		...
		{
			theThing = GameObject.Instantiate(AssetDatabase.LoadAssetAtPath("Assets/Imports/MaterialUI/ComponentPrefabs/Divider - Light.prefab", typeof(GameObject))) as GameObject;
			SetupObject("Divider");
			theThing.GetComponent<RectTransform>().anchoredPosition = Vector2.zero;
		}
		...
		{
			theThing = GameObject.Instantiate(AssetDatabase.LoadAssetAtPath("Assets/Imports/MaterialUI/ComponentPrefabs/Divider - Dark.prefab", typeof(GameObject))) as GameObject;
			SetupObject("Divider");
			theThing.GetComponent<RectTransform>().anchoredPosition = Vector2.zero;
		}
		...
		{
			theThing = GameObject.Instantiate(AssetDatabase.LoadAssetAtPath("Assets/Imports/MaterialUI/ComponentPrefabs/List Item/ListView.prefab", typeof(GameObject))) as GameObject;
		...
		{
			theThing = GameObject.Instantiate(AssetDatabase.LoadAssetAtPath("Assets/Imports/MaterialUI/ComponentPrefabs/List Item/List Item Single.prefab", typeof(GameObject))) as GameObject;
		...
		{
			theThing = GameObject.Instantiate(AssetDatabase.LoadAssetAtPath("Assets/Imports/MaterialUI/ComponentPrefabs/List Item/List Item Single Icon.prefab", typeof(GameObject))) as GameObject;
			SetupObject("List Item");
			theThing.GetComponent<RectTransform>().anchoredPosition = Vector2.zero;
		}
		...
		{
			theThing = GameObject.Instantiate(AssetDatabase.LoadAssetAtPath("Assets/Imports/MaterialUI/ComponentPrefabs/List Item/List Item Single Avatar.prefab", typeof(GameObject))) as GameObject;
			SetupObject("List Item");
			theThing.GetComponent<RectTransform>().anchoredPosition = Vector2.zero;
		}
		...
		{
			theThing = GameObject.Instantiate(AssetDatabase.LoadAssetAtPath("Assets/Imports/MaterialUI/ComponentPrefabs/List Item/List Item Single Icon Avatar.prefab", typeof(GameObject))) as GameObject;
			SetupObject("List Item");
			theThing.GetComponent<RectTransform>().anchoredPosition = Vector2.zero;
		}
		...
		{
			theThing = GameObject.Instantiate(AssetDatabase.LoadAssetAtPath("Assets/Imports/MaterialUI/ComponentPrefabs/List Item/List Item Double.prefab", typeof(GameObject))) as GameObject;
			SetupObject("List Item");
			theThing.GetComponent<RectTransform>().anchoredPosition = Vector2.zero;
		}
		...
		{
			theThing = GameObject.Instantiate(AssetDatabase.LoadAssetAtPath("Assets/Imports/MaterialUI/ComponentPrefabs/List Item/List Item Double Icon.prefab", typeof(GameObject))) as GameObject;
			SetupObject("List Item");
			theThing.GetComponent<RectTransform>().anchoredPosition = Vector2.zero;
		}
		...
		{
			theThing = GameObject.Instantiate(AssetDatabase.LoadAssetAtPath("Assets/Imports/MaterialUI/ComponentPrefabs/List Item/List Item Double Avatar.prefab", typeof(GameObject))) as GameObject;
			SetupObject("List Item");
			theThing.GetComponent<RectTransform>().anchoredPosition = Vector2.zero;
		}
		...
		{
			theThing = GameObject.Instantiate(AssetDatabase.LoadAssetAtPath("Assets/Imports/MaterialUI/ComponentPrefabs/List Item/List Item Double Icon Avatar.prefab", typeof(GameObject))) as GameObject;
			SetupObject("List Item");
			theThing.GetComponent<RectTransform>().anchoredPosition = Vector2.zero;
		}
		...
		{
			theThing = GameObject.Instantiate(AssetDatabase.LoadAssetAtPath("Assets/Imports/MaterialUI/ComponentPrefabs/List Item/List Item Triple.prefab", typeof(GameObject))) as GameObject;
			SetupObject("List Item");
			theThing.GetComponent<RectTransform>().anchoredPosition = Vector2.zero;
		}
		...
		{
			theThing = GameObject.Instantiate(AssetDatabase.LoadAssetAtPath("Assets/Imports/MaterialUI/ComponentPrefabs/List Item/List Item Triple Icon.prefab", typeof(GameObject))) as GameObject;
			SetupObject("List Item");
			theThing.GetComponent<RectTransform>().anchoredPosition = Vector2.zero;
		}
		...
		{
			theThing = GameObject.Instantiate(AssetDatabase.LoadAssetAtPath("Assets/Imports/MaterialUI/ComponentPrefabs/List Item/List Item Triple Avatar.prefab", typeof(GameObject))) as GameObject;
			SetupObject("List Item");
			theThing.GetComponent<RectTransform>().anchoredPosition = Vector2.zero;
		}
		...
		{
			theThing = GameObject.Instantiate(AssetDatabase.LoadAssetAtPath("Assets/Imports/MaterialUI/ComponentPrefabs/List Item/List Item Triple Icon Avatar.prefab", typeof(GameObject))) as GameObject;
			SetupObject("List Item");
			theThing.GetComponent<RectTransform>().anchoredPosition = Vector2.zero;
		}
		...
		{
			theThing =
				GameObject.Instantiate(AssetDatabase.LoadAssetAtPath("Assets/Imports/MaterialUI/ComponentPrefabs/Nav Drawer.prefab",
					typeof (GameObject))) as GameObject;
		...
		{
			theThing =
				GameObject.Instantiate(AssetDatabase.LoadAssetAtPath("Assets/Imports/MaterialUI/ComponentPrefabs/App Bar.prefab",
					typeof (GameObject))) as GameObject;
			SetupObject("App Bar");
			theThing.GetComponent<RectTransform>().sizeDelta = Vector2.zero;
			theThing.GetComponent<RectTransform>().anchoredPosition = Vector2.zero;
		...
		{
			theThing =
				GameObject.Instantiate(AssetDatabase.LoadAssetAtPath("Assets/Imports/MaterialUI/ComponentPrefabs/ScreenManager.prefab",
					typeof(GameObject))) as GameObject;
		...
		{
			theThing =
				GameObject.Instantiate(AssetDatabase.LoadAssetAtPath("Assets/Imports/MaterialUI/ComponentPrefabs/Screen.prefab",
					typeof (GameObject))) as GameObject;
			SetupObject("Screen");
			theThing.GetComponent<RectTransform>().sizeDelta = Vector2.zero;
			theThing.GetComponent<RectTransform>().anchoredPosition = Vector2.zero;
