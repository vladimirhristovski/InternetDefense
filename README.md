...
| Phishing Email Turret | 200$ |
| Suspicious Download Turret | 250$ |

Selling a turret refunds **50% of its cost**.
...
Selling turret враќа **50% од цената**.
...
| Копче | Акција |
|------|--------|
| Mouse | Поставување кула / интеракција |
| P | Pause |
| Escape | Pause |
| Space | Pause |
